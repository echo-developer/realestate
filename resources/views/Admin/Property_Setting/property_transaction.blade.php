        ...
        <div class="card-body">
            <div class="card-header p-0">
                ...
                <div class="btn-actions-pane-right">
                    <button type="button" class="btn btn-sm btn-success" onclick="add_prop_transaction()">Add Transaction</button>
                </div>
                ...
                <table class="mb-0 table">
                    ...
                    <tbody id="user">
                        <tr>
                            ...
                            <td>
                                <input data-id="{{$item->id}}" class="transaction_prop_status d-none" type="checkbox" data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="success" data-offstyle="danger" data-size="mini" {{$item->status ? 'checked' : '' }}>
                            </td>
                            <td class="text-right">

                                <i class="fa fa-edit text-success fa-md " onclick="Edit_prop_transaction('{{ $item->id }}')"></i>

                                <i class="fa fa-trash text-danger fa-md" onclick="Delete_prop_transaction('{{ $item->id }}')"></i>
...
@endsection
@section('modals')
<div class="modal fade" id="prop_transaction" tabindex="-1" role="dialog" aria-labelledby="prop_transactionaddEditModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="add_edit_prop_transaction()" id="prop_transactionButton" class="btn btn-primary">Save</button>
            </div>
        </div>
