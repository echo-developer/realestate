            ...
            <div class="row">
                <div class="offset-sm-8 col-sm-4">
                    <div class="input-group">
                        <input class="form-control" id="prop_status_search" placeholder="Search..." name="term" value="{{ request('term') }}" />
        ...
        <div class="card-body">
            <div class="card-header p-0">
                ...
                <div class="btn-actions-pane-right">
                    <button type="button" class="btn btn-sm btn-success" onclick="add_prop_status()">Add Status</button>
                </div>
                ...
                <table class="mb-0 table">
                    ...
                    <tbody id="user">
                        <tr>
                            ...
                            <td>
                                <input data-id="{{$item->id}}" class="status_prop_status d-none" type="checkbox" data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="success" data-offstyle="danger" data-size="mini" {{$item->status ? 'checked' : '' }}>
                            </td>
                            <td class="text-right">

                                <i class="fa fa-edit text-success fa-md " onclick="Edit_prop_status('{{ $item->id }}')"></i>

                                <i class="fa fa-trash text-danger fa-md" onclick="Delete_prop_status('{{ $item->id }}')"></i>
...
@endsection
@section('modals')
<div class="modal fade" id="prop_status" tabindex="-1" role="dialog" aria-labelledby="prop_statusaddEditModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="add_edit_prop_status()" id="prop_statusButton" class="btn btn-primary">Save</button>
            </div>
        </div>
