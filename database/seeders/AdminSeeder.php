...
class AdminSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('pref_menu_management')->insert([
            ...
            ['id' => 36, 'parent_id' => 15, 'name' => 'All properties', 'slug' => 'all-properties', 'description' => 'All Properties List', 'icon_class' => null, 'menu_code' => null, 'url' => 'allproperties/all-property-view', 'status' => 1, 'order' => null, 'action' => 'add', 'created_at' => '2024-12-17 10:15:11', 'updated_at' => '2024-12-18 08:27:42'],
        ]);
