                            ...
                            <div className="row">
                                <div className="col-md-12 col-12">
                                    <div className="floating-label-group mb-3">
                                        <label className="floating-label">Old Password<span>*</span></label>
                                    ...
                                    <div className="floating-label-group mb-3">
                                        <label className="floating-label">New Password<span>*</span></label>
                                        <Field type={showPassword ? "text" : "password"} name="newpassword" className="form-control" />
                                        <ErrorMessage name="newpassword" component="div" className="text-danger" />
                                    </div>

                                    <div className="floating-label-group mb-3">
                                        <label className="floating-label">Confirm Password<span>*</span></label>
