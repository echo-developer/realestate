            ...
            <div className="input-group mb-4">
              <FloatingLabel controlId="" label="Enter the Carpet Area:">
                <Form.Control
                  ...
                  onChange={(e) => handleAreaChange(e, "carpet_area")}
              ...
              <div className="checkbox-group">
                {flooringOptions.map((flooring) => (
                  <Form.Check
                    ...
                    onChange={(e) => {
                      setInputValue((prevState) => {
                        const selectedKeys = prevState[selectedItem] || [];

                        if (e.target.checked) {
                          // Add the key to the list of selected flooring types
                          return {
                            ...prevState,
                            [selectedItem]: [...selectedKeys, flooring.key],
                          };
                        } else {
                          // Remove the key from the list of selected flooring types
                          return {
                            ...prevState,
                            [selectedItem]: selectedKeys.filter(
      ...
      case "electric_available":
        return (
          <>
            <FloatingLabel
              controlId="floatingSelect"
              label="Select Electricity Status:"
            >
              <Form.Select
                value={inputValue[selectedItem] || ""}
                onChange={(e) =>
