    ...
    <div id="step-1">
      ...
      <div className="form-field mb-3">
        <label htmlFor="name" className="form-label">
          {translation?.name || "Name"} <span className="text-danger">*</span>
        </label>
        <input
          type="text"
          ...
          name="user_name"
          placeholder={
            translation?.placeholder_enter_your_name || "Enter your name"
          }
      ...
      <div className="mb-3">
        <label htmlFor="w_no" className="form-label">
          {translation?.whatsapp_no || "WhatsApp No"}{" "}
        ...
        {errors.w_no && <p className="text-danger small">{errors.w_no}</p>}
      </div>
      ...
      <div className="alert alert-success d-flex align-items-center">
        ...
        <p className="ps-3">
          ...
          {translation?.get_enquiries || "to get enquiries from buyer/tenant"}
        </p>
      </div>
