    ...
    <div className="container-fluid">
      <div className="row align-items-center">
        ...
        <aside className="col-md-auto">
          <Link target='_blank' href={`/agent-list?page=1&is_verified_agent=true`} className="btn btn-link">
          ...
          <article className="col-xl-3 col-lg-4 col-sm-6 col-12" key={i}>
            <div className="card card-v-agent">
              ...
              <div className="card-footer">
                <h4 className="mb-0">
                  <span className="text-primary">{agent?.property_for_sale || 0}</span> 
                  {translation?.properties_for_sale || "Properties For Sale"}
                </h4>
              </div>
            </div>
          </article>
