  ...
  const FetchProjectPropertyData = async (projectId) => {
    try {
      ...
      if (response && response?.status === 1) {
        ...
        setTowers(response.totalTowers);
        setSelectedBHKs(initializedTowers.map(t => 
          t.bhk_type_data[0]?.bhk_type || '1BHK'
        ));
      }
    } catch (error) {
                ...
                <div key={bhkIndex} className="row g-3 mb-3">
                  <div className="col-md-3">
                    <input
                      ...
                      onChange={(e) => handleBHKChange(towerIndex, bhkIndex, 'carpet_area', e.target.value)}
                    />
                  ...
                  <div className="col-md-3">
                    <input
                      ...
                      onChange={(e) => handleBHKChange(towerIndex, bhkIndex, 'super_area', e.target.value)}
                    />
                  ...
                  <div className="col-md-3">
                    <input
                      ...
                      onChange={(e) => handleBHKChange(towerIndex, bhkIndex, 'property_price', e.target.value)}
                    />
                  ...
                  <div className="col-md-2">
                    <select
                      ...
                      onChange={(e) => handleBHKChange(towerIndex, bhkIndex, 'property_facing', e.target.value)}
                    >
