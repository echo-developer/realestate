    ...
    <aside className="col-lg-auto col-12">
      <div className="user-sidebar">
        <div className="user-profile text-center">
          ...
          <div className="user-profile-details">
            ...
            <div className="d-grid columns-2 mb-3">
              <a href="post.php" className="btn btn-outline-light">
                Post Project
              </a>
              <a href="profile.php" className="btn btn-outline-light">
                View Profile
              </a>
            </div>
          </div>
        ...
        <ul className="user-nav">
          ...
          <li>
            <a href="my-property-listing.php">
              <i className="bi bi-house-check"></i> <span>My Properties</span>
            </a>
          </li>
          <li>
            <a href="favorite.php">
              <i className="bi bi-bookmark-star"></i> <span>My Favourites</span>
            </a>
          </li>
          <li>
