...
class CategoryModel extends Model
{
    ...
    public function search_Category($term = null)
    {

        // if ($term = null) {
        //     $search_result = $this->getCategories();
        // } else {


            $search_result = DB::table('pref_property_category_names')
                ->join('pref_property_category', 'pref_property_category_names.category_id', '=', 'pref_property_category.id')
                ->where('pref_property_category_names.name', 'REGEXP', $term)->get();
        // }
