                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" onclick="$('#advanceFilter').slideToggle();"
                ...
                <div class="mt-3" id="advanceFilter" style="display: none;">
                    <div class="d-flex flex-wrap gap-2 align-items-end">
                        ...
                        <div class="form-group ml-2">
                            ...
                            <input type="text" value="{{ request('address') }}" class="form-control" name="address"
                                placeholder="Enter Address" style="min-width: 180px;">
                        </div>

                        <!-- Occupied Area -->
                        <div class="form-group ml-2">
                            <label class="form-label">Occupied Area (sq.ft)</label>
                            <input type="number" value="{{ request('occupied_area') }}" class="form-control"
                                name="occupied_area" placeholder="Occupied Area" style="min-width: 130px;">
                        </div>

                        <!-- Total Area -->
                        <div class="form-group ml-2">
                            <label class="form-label">Total Area (sq.ft)</label>
                            <input type="number" value="{{ request('total_area') }}" class="form-control"
                                name="total_area" placeholder="Total Area" style="min-width: 130px;">
                        </div>
                        ...
                        <div class="form-group ml-2">
                            ...
                            <input type="number" value="{{ request('price') }}" class="form-control" name="price"
                ...
                <div class="table-responsive" id="main_table">
                    <table id='table' class="mb-0 table">
                        ...
                        <tbody>
                                ...
                                @foreach ($project as $proj)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/enquiry/project-leads/' . $proj->id) }}"
                            ...
                            @else
                                <tr>
                                    <td colspan="10"><i class="icon-feather-thumbs-down fa-md"></i> &nbsp; Sorry, No
                                        records !</td>
                                </tr>
                            @endif
                        </tbody>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (let i = 0; i < totalTowers; i++) {
                        ...
                        {}; // Use existing data if available, else empty object
