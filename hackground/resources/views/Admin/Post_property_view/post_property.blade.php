...
<section class="section post-page1">        
            ...
            <form method="post" id='post-property-form'>
                ...
                <div id="step-2" style="display:none1;">
                    ...
                    <div class="btn-group btn-group-light d-flex mb-3" role="group">
                        ...
                        <label class="btn btn-outline-light flex-column" for="owner"><img
                                src="{{ asset('assets/icons/owner.png') }}" alt="Icon" height="48" width="48" class="mb-1" />
                            Owner</label>
                        <input type="radio" class="btn-check" name="postAs" id="agent"
                            autocomplete="off" @php if($userData->user_type == 'A'){echo 'checked';} @endphp >
                        <label class="btn btn-outline-light flex-column" for="agent"><img
                                src="{{ asset('assets/icons/agent.png') }}" alt="Icon" height="48" width="48" class="mb-1" />
                            Agent</label>
                        <input type="radio" class="btn-check" name="postAs" id="builder"
                            autocomplete="off" @php if($userData->user_type == 'B'){echo 'checked';} @endphp>
                        <label class="btn btn-outline-light flex-column" for="builder"><img
                                src="{{ asset('assets/icons/builder.png') }}" alt="Icon" height="48" width="48" class="mb-1" /> 
                                Builder</label>
                    </div>
                    <div>
                        ...
                        <div class="btn-group btn-group-light d-flex mb-3" role="group">
                            ...
                            <label class="btn btn-outline-light flex-column" for="btnradio1">
                                <img src="{{ asset('assets/icons/rent-2.png') }}" alt="Icon" height="48" width="48" class="mb-1" /> 
                                Rent
                            </label>
                            <input type="radio" class="btn-check" name="postFor" id="btnradio2"
                                value="sale" autocomplete="off">
                            <label class="btn btn-outline-light flex-column" for="btnradio2">
                                <img src="{{ asset('assets/icons/sale-2.png') }}" alt="Icon" height="48" width="48" class="mb-1" /> 
                                Sale
                            </label>
                            <input type="radio" class="btn-check" name="postFor" id="btnradio3"
                                value="pg" autocomplete="off">
                            <label class="btn btn-outline-light flex-column" for="btnradio3">
                                <img src="{{ asset('assets/icons/hostel.png') }}" alt="Icon" height="48" width="48" class="mb-1" /> 
                                PG/Hostel
                            </label>
                        </div>
