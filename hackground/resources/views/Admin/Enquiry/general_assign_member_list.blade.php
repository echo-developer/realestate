        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <div class="card-header p-0">
                    ...
                    <ul>
                        <li>Property Type:
                            {{ $enquiry->property_type ? get_property_category_name($enquiry->property_type) : '' }}</li>
                        <li>Property For:
                            {{ $enquiry->property_for ? get_property_sub_category_name($enquiry->property_for) : '' }}</li>
                    </ul>
                    <ul>
                    ...
                    <ul>
                        <li>
                            ...
                            @php
                                ...
                                echo (isset($time_arr[0]) ? $time_arr[0] : '') .
                                    ' ' .
                                    (isset($time_arr[1]) ? $time_arr[1] : '');
                            @endphp
        ...
        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav ml-0">
            <li class="nav-item">
                <a class="nav-link ajax-link {{ Request::is('enquiry/general-assign-list/' . $enquiry->id) ? 'active' : '' }}"
                    href="{{ url('enquiry/general-assign-list/' . $enquiry->id) }}"
            ...
            <li class="nav-item">
                <a class="nav-link ajax-link {{ Request::is('enquiry/general-assign-list/assigned/' . $enquiry->id) ? 'active' : '' }}"
                    href="{{ url('enquiry/general-assign-list/assigned/' . $enquiry->id) }}"
                            ...
                            <tbody>
                                @forelse($list as $item)
                                    ...
                                    <tr>
                                        @if ($assign_type == 'unassigned')
                                            <td>
                                                <input name="userid[]" value="{{ $item->user_id }}" type="checkbox"
