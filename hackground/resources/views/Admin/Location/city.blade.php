                            ...
                            @if (isset($data))
                                @foreach ($data as $item)
                                    <tr>
                                        <td>{{ $item->city_id }}</td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ get_name_by_id('state_names', 'state_id', $item->state, 'en') ?? 'N/A' }}
                                        </td>
                                        ...
                                        @else
                                            <td>
                                                <span class="text-warning">
                                                    <i class="fas fa-info-circle me-1"></i> <small>Latitude & longitude
                                                        required</small>
                                                </span>
                                            </td>
                                        @endif
