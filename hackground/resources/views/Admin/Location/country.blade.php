    ...
    <div class="app-main__inner">
        ...
        <style>
            ...
            @media (max-width: 767px) {
                ...
                #modal_action .modal-dialog { position: fixed; bottom: 0; left: 0; right: 0; margin: 0; width: 100%; max-width: 100%; transform: translateY(100%); transition: transform 0.35s cubic-bezier(0.32, 0.72, 0, 1); }
                #modal_action.show .modal-dialog { transform: translateY(0); }
                #modal_action .modal-content { border-radius: 20px 20px 0 0; border: none; max-height: 90vh; display: flex; flex-direction: column; box-shadow: 0 -4px 24px rgba(0,0,0,0.15); }
                #modal_action .modal-header { border-bottom: 1px solid #f0f0f0; padding: 0.85rem 1.25rem 0.75rem; }
                #modal_action .modal-body { overflow-y: auto; -webkit-overflow-scrolling: touch; padding: 1rem 1.25rem; }
                #modal_action .modal-footer { border-top: 1px solid #f0f0f0; padding: 0.75rem 1.25rem; padding-bottom: calc(0.75rem + env(safe-area-inset-bottom)); }
                #modal_action .form-floating .form-control, #modal_action .form-floating .form-select { height: 52px; font-size: 0.95rem; }
                #button { width: 100%; height: 46px; border-radius: 12px; font-weight: 600; }
            }
        ...
        <div class="main-card mb-3 card card-modern">
            <div class="settings-card-header">
                <h4><i class="bi bi-globe text-primary me-2"></i> Country List</h4>
                <div class="btn-actions-pane-right">
                    <button type="button" class="btn-add-setting" onclick="add()">
                        <i class="fa fa-plus me-1"></i> Add Country
                    </button>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="myTable" class="settings-table">
                        ...
                        <tbody id="user">
                            @if (isset($data))
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Action" class="text-right">
                                            <div class="actions-cell">
                                                <a href="javascript:void(0)" onclick="Edit('{{ $item->id }}')" class="action-icon-btn edit cursor-pointer">
                                                    <i class="bi bi-pencil-square pointer-events-none"></i>
                                                </a>
                                                <a href="javascript:void(0)" onclick="Delete('{{ $item->id }}')" class="action-icon-btn delete cursor-pointer">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-4">Sorry, no records found!</td>
                                    </tr>
                                @endforelse
                        </tbody>
                        @endif
