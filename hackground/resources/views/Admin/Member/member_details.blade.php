        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-lg-6 mb-3 text-center">
                    <img id="user_image_preview" src="{{ !empty($data->image_url) ? $data->image_url : asset('user_upload/profile_image/user.jpg') }}" alt="User Image" class="rounded-circle mb-3" height="100" width="100">        
                    <div class="mx-auto">
            ...
            <form method="POST" action="{{ route('save.user.details') }}" enctype="multipart/form-data">
                ...
                @if ($data?->user_type === 'A')
                    ...
                    <hr>
                    <h5><strong>Service Area</strong></h5>
                    <div id="business-address-wrapper">
                        {{-- <div class="row address-field" id="field-1" data-field-id="">
                            <div class="col mb-3">
