    ...
    <div class="app-main__inner">
        ...
        <style>
            ...
            @media (max-width: 767px) {
                ...
                #prop_testimonial .modal-dialog { position: fixed; bottom: 0; left: 0; right: 0; margin: 0; width: 100%; max-width: 100%; transform: translateY(100%); transition: transform 0.35s cubic-bezier(0.32, 0.72, 0, 1); }
                #prop_testimonial.show .modal-dialog { transform: translateY(0); }
                #prop_testimonial .modal-content { border-radius: 20px 20px 0 0; border: none; max-height: 90vh; display: flex; flex-direction: column; box-shadow: 0 -4px 24px rgba(0,0,0,0.15); }
                #prop_testimonial .modal-header { border-bottom: 1px solid #f0f0f0; padding: 0.85rem 1.25rem 0.75rem; }
                #prop_testimonial .modal-body { overflow-y: auto; -webkit-overflow-scrolling: touch; padding: 1rem 1.25rem; }
                #prop_testimonial .modal-footer { border-top: 1px solid #f0f0f0; padding: 0.75rem 1.25rem; padding-bottom: calc(0.75rem + env(safe-area-inset-bottom)); }
                #prop_testimonial .form-floating .form-control, #prop_testimonial .form-floating .form-select { height: 52px; font-size: 0.95rem; }
                #prop_testimonialButton { width: 100%; height: 46px; border-radius: 12px; font-weight: 600; }
            }
        ...
        <div class="main-card mb-3 card card-modern">
            <div class="settings-card-header">
                <h4><i class="fa fa-quote-left text-primary me-2"></i> Testimonial List</h4>
                <div class="btn-actions-pane-right">
                    <button type="button" class="btn-add-setting" onclick="add_prop_testimonial()">
                        ...
                        <tbody id="user">
                            @forelse($data as $item)
                                <tr>
                                    ...
                                    <td data-label="Name"><span>{{ $item->name }}<br><small class="text-muted">{{ $item->subname }}</small></span></td>
                                    ...
                                    <td data-label="Image">
                                        <div class="d-flex justify-content-end w-100">
                                            <img src="{{ $imageToShow }}" alt="Testimonial Image" class="img-fluid rounded" height="48" width="48" style="object-fit: cover;">
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    ...
                    <h5 class="modal-title fw-bold" id="prop_testimonialAddEditModalLabel"></h5>
