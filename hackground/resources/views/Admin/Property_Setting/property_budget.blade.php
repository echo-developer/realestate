...
<div class="app-main__inner">
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Property Budget
                    <div class="page-title-subheading">Property Setting &gt; Property Budget List</div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header d-flex">
            <h4>Property Budget List</h4>

            <div class="btn-actions-pane-right">
                <button type="button" class="btn btn-sm btn-primary" onclick="add_prop_budget()">Add
                    Budget</button>
            </div>
            ...
            <div class="modal-body">
                ...
                <form id="prop_budgetformData">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input type="number" class="form-control" id="max_budget" name="max_budget" placeholder="" required>
