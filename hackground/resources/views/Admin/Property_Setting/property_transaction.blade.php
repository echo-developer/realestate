...
<div class="app-main__inner">
        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Property Transaction
                    <div class="page-title-subheading">Property Setting &gt; Property Transaction List</div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        ...
        <h4>Property Transaction List</h4>

            <div class="btn-actions-pane-right">
                <button type="button" class="btn btn-sm btn-primary" onclick="add_prop_transaction()">Add
                    Transaction</button>
            </div>
