                ...
                <table class="mb-0 table">
                    ...
                    <tbody id="user">
                        ...
                        <tr>
                            ...
                            <!-- Display Icon (Assuming icon is in 'badges' table) -->
                            <td>
                                @if ($data->badge && $data->badge->icon)
                                <img src="{{ asset('user_upload/badges/' . $data->badge->icon) }}" alt="Icon" height="40">
                                @else
                                <span class="text-warning">No Icon</span>
                                @endif
                            </td>
                            ...
                            <td class="text-right">
                                <a href="javascript:void(0)" class="me-2 edit" data-id="{{ $data->badge_id }}">
                                    <i class="bi bi-pencil-square text-success fa-md"></i>
                                </a>
                                <a href="javascript:void(0)" class="delete" data-id="{{ $data->badge_id }}">
