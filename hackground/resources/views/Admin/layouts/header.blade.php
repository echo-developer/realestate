                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img height="40" width="40" class="rounded-circle" src="{{ asset('assets/images/bappa-agent.jpg') }}" alt="">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href={{url('logout')}}><button class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                                </button></a>
                                                                </div>
                                                            </div>
                                                        </div>
