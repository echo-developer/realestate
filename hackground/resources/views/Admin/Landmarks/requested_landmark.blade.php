...
@section('content')
    ...
    <div class="app-main__inner">
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Requested Landmarks</div>
                </div>
                <div class="page-title-actions">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}"> Home</a></li>
                        <li class="breadcrumb-item active">Requested Landmarks List</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        @if (session('success_msg'))
            <div class="alert alert-{{ session('message_type') }} alert-dismissible mt-2">
                {{ session('success_msg') }}
        ...
        <div class="main-card mb-3 card">
            <div class="card-header d-flex">
                <h4>Requested Landmarks List</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="formData">
                        ...
                        <div class="mb-3">
                            <label for="page_name"> Type </label>
                        ...
                        <div class="mb-3">
                            <label for="page_name"> Distance </label>
                            <input type="number" class="form-control reset_field" id="distance" name="distance"
                                autocomplete="off">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="saveButton" class="btn btn-success">Approve</button>
                    </div>
                </div>
            </div>
...
@push('custom-js')
    <script>
        $(document).ready(function() {
            ...
            $('#saveButton').on('click', approveLandmark);
            ...
            function editData() {
                ...
                let id = $(this).data('id');
                $.ajax({
                    url: "{{ route('landmark-requested.edit', ':id') }}".replace(':id', id),
                    type: 'GET',
                    success: function(response) {
                        ...
                        $('input[name=status][value="' + response.is_approved + '"]').prop('checked',
                            true);
            ...
            function approveLandmark() {
                ...
                $.ajax({
                    url: `{{ route('landmark-requested.approve', ':id') }}`.replace(':id', id),
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
