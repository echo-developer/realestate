...
class BusStandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['status' => 1, 'message' => 'Bus created successfully']);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return response()->json(['status' => 1, 'message' => 'Bus Updated successfully']);
    }
    public function statusUpdate(Request $request)
    {
        $status = $request->input('status');
        $id = $request->input('id');
        Bus::where('id', $id)->update(['status' => $status]);
