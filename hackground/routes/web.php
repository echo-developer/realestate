...
use App\Http\Controllers\Admin\PropertyReportsController;
...
*/
    ...
    Route::prefix('member')->controller(UserController::class)->group(function () {
        ...
        Route::post('/memberUser/save-details', 'SaveMemberDetails')->name('save.user.details');
...
*/
    ...
    Route::controller(AdvertisementController::class)->group(function () {
        ...
        Route::post('advertisement/request-change-status', 'request_change_status');
...
Route::prefix('reports')->name('reports.')->controller(PropertyReportsController::class)->group(function () {
